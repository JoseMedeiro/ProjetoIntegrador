function f = sim_model(x)
  ...
  Ebat = 30;     % energy specific density (W.h/kg)
  ...
  n_ES = 0.95;		% Electric system efficiency (-)
  PWe = 5;          % Power to weight ratio (kW/kg)
  PWesc = 20;       % Power to weight ratio (kW/kg)
  MI = 0.4;         % Electric motor integration factor (-)
  ...
  Battery_production = 80.8;                                        % CO2-eq emissions per kW.h of battery produced (gCO2eq/(kW.h))
